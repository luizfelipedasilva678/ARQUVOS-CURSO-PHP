<nav class="modulos">
    <div class="modulo roxo-escuro">
        ...
        <ul>
            <li>
                <a href="exercicio.php?dir=banco_dados&file=alterar_pdo">
                   Alterar PDO
                </a>
            </li>
            <li>
                <a href="exercicio.php?dir=banco_dados&file=delete_pdo">
                   Delete PDO
                </a>
            </li>
            <li>
                <a href="exercicio.php?dir=banco_dados&file=consultar_pdo">
                   Consultar PDO
                </a>
            </li>
            <li>
                <a href="exercicio.php?dir=banco_dados&file=inserir_pdo">
                   Inserção PDO
                </a>
            </li>
            <li>
                <a href="exercicio.php?dir=banco_dados&file=alterar">
                   Alterar
                </a>
            </li>
            <li>
                <a href="exercicio.php?dir=banco_dados&file=incluir_2">
                   Incluir #02
                </a>
            </li>
            <li>
                <a href="exercicio.php?dir=banco_dados&file=excluir_2">
                   Excluir Registros #02
                </a>
            </li>
            <li>
                <a href="exercicio.php?dir=banco_dados&file=excluir_registro">
                   Excluir Registros #01
                </a>
            </li>
            <li>
                <a href="exercicio.php?dir=banco_dados&file=consultar_registros">
                   Consultar Registros
                </a>
            </li>
            <li>
                <a href="exercicio.php?dir=banco_dados&file=inserir_dados">
                   Incluir #1
                </a>
            </li>
            <li>
                <a href="exercicio.php?dir=banco_dados&file=criar_tabela">
                   Criar Tabela
                </a>
            </li>
            <li>
                <a href="exercicio.php?dir=banco_dados&file=conexao">
                   Conexão com banco de bados
                </a>
            </li>
            <li>
                <a href="exercicio.php?dir=banco_dados&file=criar_banco">
                    Criar Banco
                </a>
            </li>
        </ul>
